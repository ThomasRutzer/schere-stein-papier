...
export const MODEL_OUTSIDE_POSITION_TOP = [0, 9, 0]
export const MODEL_INSIDE_POSITION_TOP = [0, 5, 0]
...
export const YOUR_SELECTION_NOT_SELECTED = "WILL_LOSE"

export const YOU = "YOU"
export const OPPONENT = "OPPONENT"
export const DRAW = "DRAW"

export const MESSAGE_DRAW = "It's a tie"
